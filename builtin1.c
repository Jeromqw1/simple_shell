...
*  with each command preceded by line numbers, starting at 0.
*
* Parameters:
...
/**
* unset_alias - Removes an alias associated with a specific string.
* Parameters:
...
/**
* set_alias - Sets alias to a specific string
* @info: Parameter struc containing information about the shell
...
/**
* print_alias - Prints an alias string in the format 'alias_string'.
...
* from regular shell.
* It can print existing aliases or set new ones
* @info: Structure containing potential arguments.
